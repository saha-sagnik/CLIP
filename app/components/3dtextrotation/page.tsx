...
import { swiftUI3DTextRotationCode, swiftUI3DTextRotationProps } from './swiftui';
import { compose3DTextRotationCode, compose3DTextRotationProps } from './compose';
import { reactNative3DTextRotationCodeTS, reactNative3DTextRotationCodeJS, reactNative3DTextRotationProps } from './reactnative';
...
const frameworks = [
  { id: 'swiftui', label: 'SwiftUI', code: swiftUI3DTextRotationCode },
  { id: 'compose', label: 'Compose', code: compose3DTextRotationCode },
  { id: 'reactnative', label: 'React Native', code: reactNative3DTextRotationCodeTS }
];

export default function ThreeDTextRotationPage() {
  ...
  const getSelectedProps = () => {
    return swiftUI3DTextRotationProps;
  };
  ...
  return (
    <div className="px-8 py-32">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-foreground">3D Text Rotation</h1>
          <p className="text-lg text-muted-foreground">
            Text component with 3D rotation animation
          </p>
        </div>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
                  ...
                  <div className="flex flex-col items-center justify-center min-h-[400px] bg-violet-500/5 rounded-lg">
                    <MobileFrame platform="ios">
                      <div className="flex items-center justify-center h-full bg-gradient-to-br from-violet-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
                        ...
                        <div>3D Text Rotation Preview</div>
                      </div>
                    </MobileFrame>
                  </div>
                </div>
              ...
              {activeTab === 'code' && (
                <CodeDisplay 
                  ...
                  reactNativeSupport={{
                    typescript: reactNative3DTextRotationCodeTS,
                    javascript: reactNative3DTextRotationCodeJS
                  }}
                />
              )}

              {activeTab === 'cli' && (
                <CLIInstall componentName="3dtextrotation" />
              )}
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Customization controls for 3D Text Rotation will be added here.
                </p>
              </div>
            </div>
