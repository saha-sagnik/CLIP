...
import { swiftUIFlexCode, swiftUIFlexProps } from './swiftui';
import { composeFlexCode, composeFlexProps } from './compose';
import { reactNativeFlexCodeTS, reactNativeFlexCodeJS, reactNativeFlexProps } from './reactnative';
...
const frameworks = [
  { id: 'swiftui', label: 'SwiftUI', code: swiftUIFlexCode },
  { id: 'compose', label: 'Compose', code: composeFlexCode },
  { id: 'reactnative', label: 'React Native', code: reactNativeFlexCodeTS }
];
  ...
  return (
    <div className="px-8 py-32">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-foreground">Flex</h1>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
              ...
              {activeTab === 'code' && (
                <CodeDisplay 
                  ...
                  reactNativeSupport={{
                    typescript: reactNativeFlexCodeTS,
                    javascript: reactNativeFlexCodeJS
                  }}
                />
              )}

              {activeTab === 'cli' && (
                <CLIInstall componentName="flex" />
              )}
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Customization controls for Flex will be added here.
                </p>
              </div>
            </div>
