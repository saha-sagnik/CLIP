...
import { swiftUIScrambleTextCode, swiftUIScrambleTextProps } from './swiftui';
import { composeScrambleTextCode, composeScrambleTextProps } from './compose';
import { reactNativeScrambleTextCodeTS, reactNativeScrambleTextCodeJS, reactNativeScrambleTextProps } from './reactnative';
...
const frameworks = [
  { id: 'swiftui', label: 'SwiftUI', code: swiftUIScrambleTextCode },
  { id: 'compose', label: 'Compose', code: composeScrambleTextCode },
  { id: 'reactnative', label: 'React Native', code: reactNativeScrambleTextCodeTS }
];
...
export default function ScrambleTextPage() {
  ...
  const getSelectedProps = () => {
    return swiftUIScrambleTextProps;
  };
  ...
  return (
    <div className="px-8 py-32">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-foreground">ScrambleText</h1>
          <p className="text-lg text-muted-foreground">
            Text with scramble/shuffle animation
          </p>
        </div>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
                  ...
                  <div className="flex flex-col items-center justify-center min-h-[400px] bg-violet-500/5 rounded-lg">
                    <MobileFrame platform="ios">
                      <div className="flex items-center justify-center h-full bg-gradient-to-br from-violet-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
                        ...
                        <div>Your ScrambleText Preview</div>
                      </div>
                    </MobileFrame>
                  </div>
                </div>
              ...
              {activeTab === 'code' && (
                <CodeDisplay 
                  ...
                  reactNativeSupport={{
                    typescript: reactNativeScrambleTextCodeTS,
                    javascript: reactNativeScrambleTextCodeJS
                  }}
                />
              )}

              {activeTab === 'cli' && (
                <CLIInstall componentName="scrambletext" />
              )}
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Customization controls for ScrambleText will be added here.
                </p>
              </div>
            </div>
