...
import { swiftUITabsCode, swiftUITabsProps } from './swiftui';
import { composeTabsCode, composeTabsProps } from './compose';
import { reactNativeTabsCodeTS, reactNativeTabsCodeJS, reactNativeTabsProps } from './reactnative';
...
const frameworks = [
  { id: 'swiftui', label: 'SwiftUI', code: swiftUITabsCode },
  { id: 'compose', label: 'Compose', code: composeTabsCode },
  { id: 'reactnative', label: 'React Native', code: reactNativeTabsCodeTS }
];
  ...
  return (
    <div className="px-8 py-32">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-foreground">Tabs</h1>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
              ...
              {activeTab === 'code' && (
                <CodeDisplay 
                  ...
                  reactNativeSupport={{
                    typescript: reactNativeTabsCodeTS,
                    javascript: reactNativeTabsCodeJS
                  }}
                />
              )}

              {activeTab === 'cli' && (
                <CLIInstall componentName="tabs" />
              )}
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Customization controls for Tabs will be added here.
                </p>
              </div>
            </div>
