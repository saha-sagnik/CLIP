...
import { swiftUIGridCode, swiftUIGridProps } from './swiftui';
import { composeGridCode, composeGridProps } from './compose';
import { reactNativeGridCodeTS, reactNativeGridCodeJS, reactNativeGridProps } from './reactnative';
...
const frameworks = [
  { id: 'swiftui', label: 'SwiftUI', code: swiftUIGridCode },
  { id: 'compose', label: 'Compose', code: composeGridCode },
  { id: 'reactnative', label: 'React Native', code: reactNativeGridCodeTS }
];
  ...
  return (
    <div className="px-8 py-32">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-foreground">Grid</h1>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
              ...
              {activeTab === 'code' && (
                <CodeDisplay 
                  ...
                  reactNativeSupport={{
                    typescript: reactNativeGridCodeTS,
                    javascript: reactNativeGridCodeJS
                  }}
                />
              )}

              {activeTab === 'cli' && (
                <CLIInstall componentName="grid" />
              )}
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Customization controls for Grid will be added here.
                </p>
              </div>
            </div>
