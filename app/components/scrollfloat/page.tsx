...
import { swiftUIScrollFloatCode, swiftUIScrollFloatProps } from './swiftui';
import { composeScrollFloatCode, composeScrollFloatProps } from './compose';
import { reactNativeScrollFloatCodeTS, reactNativeScrollFloatCodeJS, reactNativeScrollFloatProps } from './reactnative';
...
const frameworks = [
  { id: 'swiftui', label: 'SwiftUI', code: swiftUIScrollFloatCode },
  { id: 'compose', label: 'Compose', code: composeScrollFloatCode },
  { id: 'reactnative', label: 'React Native', code: reactNativeScrollFloatCodeTS }
];
...
export default function ScrollFloatPage() {
  ...
  const getSelectedProps = () => {
    return swiftUIScrollFloatProps;
  };
  ...
  return (
    <div className="px-8 py-32">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-foreground">ScrollFloat</h1>
          <p className="text-lg text-muted-foreground">
            Text with scroll-based floating animation
          </p>
        </div>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
                  ...
                  <div className="flex flex-col items-center justify-center min-h-[400px] bg-violet-500/5 rounded-lg">
                    <MobileFrame platform="ios">
                      <div className="flex items-center justify-center h-full bg-gradient-to-br from-violet-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
                        ...
                        <div>Your ScrollFloat Preview</div>
                      </div>
                    </MobileFrame>
                  </div>
                </div>
              ...
              {activeTab === 'code' && (
                <CodeDisplay 
                  ...
                  reactNativeSupport={{
                    typescript: reactNativeScrollFloatCodeTS,
                    javascript: reactNativeScrollFloatCodeJS
                  }}
                />
              )}

              {activeTab === 'cli' && (
                <CLIInstall componentName="scrollfloat" />
              )}
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Customization controls for ScrollFloat will be added here.
                </p>
              </div>
            </div>
