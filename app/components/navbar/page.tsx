...
import { swiftUINavbarCode, swiftUINavbarProps } from './swiftui';
import { composeNavbarCode, composeNavbarProps } from './compose';
import { reactNativeNavbarCodeTS, reactNativeNavbarCodeJS, reactNativeNavbarProps } from './reactnative';
...
const frameworks = [
  { id: 'swiftui', label: 'SwiftUI', code: swiftUINavbarCode },
  { id: 'compose', label: 'Compose', code: composeNavbarCode },
  { id: 'reactnative', label: 'React Native', code: reactNativeNavbarCodeTS }
];
  ...
  return (
    <div className="px-8 py-32">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-foreground">Navbar</h1>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
              ...
              {activeTab === 'code' && (
                <CodeDisplay 
                  ...
                  reactNativeSupport={{
                    typescript: reactNativeNavbarCodeTS,
                    javascript: reactNativeNavbarCodeJS
                  }}
                />
              )}

              {activeTab === 'cli' && (
                <CLIInstall componentName="navbar" />
              )}
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Customization controls for Navbar will be added here.
                </p>
              </div>
            </div>
