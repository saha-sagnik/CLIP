...
import { swiftUIBlinkingTextEffectCode, swiftUIBlinkingTextEffectProps } from './swiftui';
import { composeBlinkingTextEffectCode, composeBlinkingTextEffectProps } from './compose';
import { reactNativeBlinkingTextEffectCodeTS, reactNativeBlinkingTextEffectCodeJS, reactNativeBlinkingTextEffectProps } from './reactnative';
...
const frameworks = [
  { id: 'swiftui', label: 'SwiftUI', code: swiftUIBlinkingTextEffectCode },
  { id: 'compose', label: 'Compose', code: composeBlinkingTextEffectCode },
  { id: 'reactnative', label: 'React Native', code: reactNativeBlinkingTextEffectCodeTS }
];

export default function BlinkingTextEffectPage() {
  ...
  const getSelectedProps = () => {
    return swiftUIBlinkingTextEffectProps;
  };
  ...
  return (
    <div className="px-8 py-32">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-foreground">BlinkingTextEffect</h1>
          <p className="text-lg text-muted-foreground">
            Text with blinking/flashing animation
          </p>
        </div>
            ...
            <div className="bg-card border border-border rounded-xl overflow-hidden">
                  ...
                  <div className="flex flex-col items-center justify-center min-h-[400px] bg-violet-500/5 rounded-lg">
                    <MobileFrame platform="ios">
                      <div className="flex items-center justify-center h-full bg-gradient-to-br from-violet-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
                        ...
                        <div>Your BlinkingTextEffect Preview</div>
                      </div>
                    </MobileFrame>
                  </div>
                </div>
              ...
              {activeTab === 'code' && (
                <CodeDisplay 
                  ...
                  reactNativeSupport={{
                    typescript: reactNativeBlinkingTextEffectCodeTS,
                    javascript: reactNativeBlinkingTextEffectCodeJS
                  }}
                />
              )}

              {activeTab === 'cli' && (
                <CLIInstall componentName="blinkingtexteffect" />
              )}
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Customization controls for BlinkingTextEffect will be added here.
                </p>
              </div>
            </div>
